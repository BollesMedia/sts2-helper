create table character_strategies (
  id text primary key,              -- ironclad, silent, defect, regent, necrobinder
  display_name text not null,
  strategy text not null,
  updated_at timestamptz default now()
);

insert into character_strategies (id, display_name, strategy) values
('the ironclad', 'The Ironclad', 'Ironclad archetypes (pick one, don''t mix):
...
('the silent', 'The Silent', 'Silent archetypes:
...
('the defect', 'The Defect', 'Defect archetypes:
...
('the regent', 'The Regent', 'Regent archetypes:
...
('the necrobinder', 'The Necrobinder', 'Necrobinder archetypes:
