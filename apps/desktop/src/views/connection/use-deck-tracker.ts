...
import type { GameState, CombatCard, BattlePlayer } from "@sts2/shared/types/game-state";
import { isCombatState, hasRun, getPlayer } from "@sts2/shared/types/game-state";
